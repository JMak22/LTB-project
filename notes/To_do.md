...
## Moar Data!
- download Location Reports from TOn.ca Open Data site: L5 filings and General Applications

## Cleanup Data!
- take the downloaded AvgHearingToOrder.xlsx set and clean, norm, csv (it's on my computer, you can't have it!)

## Graph/vis
- take the vis that's on comp and publish to GH (received, hearings, backlog, staffing, etc.)
